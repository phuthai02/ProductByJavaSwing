...
public class ThongKeFrame extends javax.swing.JFrame {
    ...
    void fillTableSP() {
        ...
        fillChartPanelToPanel(pnlChartSP, chartBaoCao(lst, "THỐNG KÊ SẢN PHẨM", "SẢN PHẨM", "DOANH THU MANG LẠI", 1, 4, "ĐỒNG"));
    }
    ...
    void setTableNL() {
        String h[] = {"Mã nguyên liệu", "Tên nguyên liệu", "Số lượng đã mua",};
    ...
    void fillTableNL() {
        ...
        for (Object[] obj : lst) {
            modelNL.addRow(new Object[]{obj[0], obj[1], obj[2]});
        }
        fillChartPanelToPanel(pnlChartNL, chartBaoCao(lst, "THỐNG KÊ NGUYÊN LIỆU", "NGUYÊN LIỆU", "SỐ LƯỢNG", 1, 2, "DVT"));
    }
    ...
    void fillTableKH() {
        ...
        fillChartPanelToPanel(pnlChartKH, chartBaoCao(lst, "THỐNG KÊ KHÁCH HÀNG", "KHÁCH HÀNG", "DOANH THU ĐEM LẠI", 1, 3, "DỒNG"));
    }
